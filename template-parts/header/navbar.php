    ...
    <div class="navbar__logo">
        ...
        <nav id="" class="navbar__nav">
            ...
            <a href="#" class="navbar__close">
                <svg class="navbar__icon" xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24"><path fill="current" stroke="#ffffff" stroke-linecap="round"  stroke-linejoin="round" stroke-width="2" d="m7 7l10 10M7 17L17 7"/></svg>
            </a>
        </nav>
</div>
